                ...
                <div class="col-xs-9">
                    <div class="casinos-content-full">
                        ...
                        <div class="row pading">
                            ...
                            <?php
                            $query = null;
                            $query = new WP_Query( array( 'post_type' => 'gambling',
                                'posts_per_page' => '200') );
                            if($query->have_posts()) {
                                while($query->have_posts()) {
                                    ...
                                    <div class="col-xs-12 site-con">
                                        <div class="col-xs-2 clear name"><img width="120" height="50" src="<?php
                                            ...
                                            ?>" alt="Bitcoin Gambling site logo"> <a href="<?php the_permalink(); ?>"><?php
                                                if(ICL_LANGUAGE_CODE == 'ru') {
                                                    echo 'Подробнее';
                                                }
                                                else {
